...
namespace ConcertLab.Controllers
{
    public class ConcertController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Date,Price,Place,ImageUrl")] ConcertModel concertModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Date,Price,Place,ImageUrl")] ConcertModel concertModel)
        {
